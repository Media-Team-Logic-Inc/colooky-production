      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <Link href="/" className="flex items-center group">
            ...
            <span className="ml-2 text-xl font-bold text-slate-900 dark:text-white">Colooky</span>
          </Link>
            ...
            {user && (
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors p-2 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800/50"
                >
                  <img
